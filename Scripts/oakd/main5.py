    ...
    while True:
        ...
        for detection in detections:
            ...
            if confidence > 80:
                ...
                command = "null"
                center_of_object = (x1 + x2) /2

                if center_of_object < 30: 
                    command = "L4"
                elif center_of_object < 60: 
                    command = "L3"
                elif center_of_object < 90: 
                    command = "L2"
                elif center_of_object < 120: 
                    command = "L1"
                elif center_of_object < 150: 
                    command = "Center"
                elif center_of_object < 180: 
                    command = "Center"
                elif center_of_object < 210: 
                    command = "R1"
                elif center_of_object < 240: 
                    command = "R2"
                elif center_of_object < 270: 
                    command = "R3"
                elif center_of_object < 300: 
                    command = "R4"


                print(f"Object: {label}. Confidence: {confidence:.2f}% Coordinates: {x1, y1, x2, y2} Command: {command}")
