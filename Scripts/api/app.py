...
def setup_COM():
    try:
        ...
        for onePort in ports:
            ...
            print(str(onePort))
        val = input("Select Port: ttyS")
        portVal = "/dev/ttyS" + str(val)
        ...
        print("Failed to establish COM port")
@app.route("/setupCOM")
def setupCOM_response():
    return Response(setup_COM(), mimetype='multipart/x-mixed-replace; boundary=frame')
