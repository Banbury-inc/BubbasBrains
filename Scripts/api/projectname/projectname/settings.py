...
SECRET_KEY = 'django-insecure-^+4@$s_f5om(0x)u0_o2b$4h3gttw@s#kk%jb+9nt%prs+0shu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '/home/mmills/Documents/Repositories/BubbasBrains/Website')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = '/home/mmills/Documents/Repositories/BubbasBrains/Website/assets/'
STATIC_URL = '/home/mmills/Documents/Repositories/BubbasBrains/Website/'
# Default primary key field type
# https://docs.djangoproject.com/en/4.2/ref/settings/#default-auto-field
STATICFILES_DIRS=(os.path.join(STATIC_ROOT,'bootstrap','css'),
                  os.path.join(STATIC_ROOT,'web','assets','mobirise-icons2'),
                  os.path.join(STATIC_ROOT,'bootstrap','js'),
                  os.path.join(STATIC_ROOT,'parallax'),
                  os.path.join(STATIC_ROOT,'rest_framework'),
                  os.path.join(STATIC_ROOT,'embla'),
